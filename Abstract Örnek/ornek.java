//sekil isimli soyut sınıfı yazınız. Bu sınıfın içeriği:
...
//ucgen, yamuk ve daire isimli sınıfları geometrikSekil sınıfından kalıtım yoluyla oluşturunuz. Bu sınıfların içeriği:
//          yukseklik ve taban değişkenleri: ucgen sınıfına ait double tipindeki değişkenlerdir.
//          alt, ust ve h değişkenleri: yamuk sınıfına ait double tipindeki değişkenlerdir.
//          yaricap ve pi değişkenleri: daire sınıfana ait double tipindeki değişkenlerdir.
...
//SoyutSınıfOrnegi sınıfını yazınız. Sınıf ana metodu içermekte olup tüm sınıflardan bir nesne yaratmaktadır. Nesnelere gerekli parametreleri göndererek
//nesnelerin isim bilgisini ve alan hesabını alarak ekrana yazdırır.