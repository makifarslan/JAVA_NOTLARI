public class Hesaplama3{
    ...
    public static class Toplama3{
        ...
        public int toplamaYap(int a, int b){
            ...
            sonuc = toplam = a + b;
            return sonuc;
            //Toplama3 statik dahili üye sınıfının , toplamaYap() yordamının içerisinde, Hesaplama3 sınıfına ait global olarak tanımlanmış ilkel(primitive) int tipindeki sabit alanına direk erişilemez.
        }
        ...
        public void dekontOlustur(){
            ...
            //Eğer statik dahili üye sınıfın içerisinden, onu çevreleyen sınıfa ait bir alan(statik olmayan) veya yordam(statik olmayan) çağırılmak isteniyorsa bu bizzat ifade edilmelidir.
    ...
    public static void main(String[] args){
        ...
        //Toplama3 statik dahili üye sınıfına ait nesne oluştururken, onu çevreleyen sınıfa ait herhangi bir nesne oluşturmak zorunda kalmadık.
